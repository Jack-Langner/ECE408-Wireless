...
% trel3 = poly2trellis(6,[47 53 75]);
trel3 = poly2trellis(3,[5 7 7]);
trel4 = poly2trellis(5,[25 27 27 37]);
%trel4 = poly2trellis(3,[5 7 7 7]);
...
hCE13 = comm.ConvolutionalEncoder(trel3,'TerminationMethod','Truncated');
hCE14 = comm.ConvolutionalEncoder(trel4,'TerminationMethod','Truncated');
...
hVD13 = comm.ViterbiDecoder(trel3,...
        'InputFormat','Hard','TerminationMethod','Truncated');
hVD14 = comm.ViterbiDecoder(trel4,...
        'InputFormat','Hard','TerminationMethod','Truncated');    
...
elseif isequal(RATE,4)
    rateStruct.eccRate = 1/3;
    rateStruct.hConvEnc = hCE13;
    rateStruct.hVitDec = hVD13;
    rateStruct.hVitDec.TracebackDepth = 7*(3-1);
    rateStruct.hMod = comm.BPSKModulator('PhaseOffset',pi);
    rateStruct.hDemod = comm.BPSKDemodulator('PhaseOffset',pi);
    rateStruct.R1R4 = [1 1 0 1];
    rateStruct.NBPSC = 1;
    ...
    rateStruct.NCBPS = 96;
    rateStruct.NDBPS = rateStruct.NCBPS*rateStruct.eccRate;
    rateStruct.ttl = '5 Mbps';
elseif isequal(RATE,2)
    rateStruct.eccRate = 1/4;
    rateStruct.hConvEnc = hCE14;
    rateStruct.hVitDec = hVD14;
    rateStruct.hVitDec.TracebackDepth = 7*(5-1);
    rateStruct.hMod = comm.BPSKModulator('PhaseOffset',pi);
    rateStruct.hDemod = comm.BPSKDemodulator('PhaseOffset',pi);
    rateStruct.R1R4 = [1 1 0 1];
    rateStruct.NBPSC = 1;
